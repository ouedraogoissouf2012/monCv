                ...
                pw.Expanded(
                  child: pw.ClipRRect(
                    ...
                    child: pw.LinearProgressIndicator(
                      ...
                      minHeight: 3,
                      backgroundColor:
                          PdfColor(accent.red, accent.green, accent.blue, 0.12),
                      valueColor: accent,
                    ),
                  ),
                ),
  ...
  pw.Widget atsSection(String title) => pw.Padding(
        ...
        child: pw.Column(
          ...
          children: [
            ...
            pw.Container(
                height: 0.8, decoration: const pw.BoxDecoration(color: black)),
          ],
        ),
      );
  ...
  doc.addPage(pw.MultiPage(
    ...
    build: (ctx) => [
      ...
      if (info?.resumeProfessionnel?.isNotEmpty == true) ...[
        ...
        pw.Text(_sanitize(info!.resumeProfessionnel!),
            style: const pw.TextStyle(
                fontSize: 10, color: black, lineSpacing: 1.3)),
      ],
      if (splitNames.isNotEmpty) ...[
        atsSection('Compétences'),
        pw.Text(splitNames.join('  -  '),
      ...
      if (cv.languages.isNotEmpty) ...[
        ...
        pw.Text(
          cv.languages
              .map((l) =>
                  '${_sanitize(l.langue ?? '')} (${_niveauLabel(l.niveau)})')
              .join('  -  '),
          style: const pw.TextStyle(fontSize: 10, color: black),
        ),
      ],
                        ...
                        children: [
                          ...
                          pw.Text(
                              _dateRange(e.dateDebut, e.dateFin,
                                  actuel: e.actuel),
                              style:
                                  const pw.TextStyle(fontSize: 9, color: grey)),
                        ]),
                    pw.Text(
